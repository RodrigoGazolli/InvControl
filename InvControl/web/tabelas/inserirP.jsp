...
<html lang="pt-br">
    <head>
        ...
        <title>Cadastrar - InvControl</title>
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="inserirP.jsp" style="text-decoration: none; color: black">Inserir</a></li>
                            <li class="breadcrumb-item active"><a href="alterar.jsp" style="text-decoration: none; color: gray">Alterar</a></li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
                                
                                <!--forms para cadastrar produtos-->
                                <form method="post" action="inserir.jsp">
                                    ...
                                    <div class="row mb-1 mt-2" style="margin-left: 0.5rem">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    ...
                                                    <input class="form-control" id="p_nome" type="text" name="p_nome" value="" placeholder="Nome do Produto" maxlength="50" required/>
                                                    <label for="p_nome">Nome do produto</label>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-floating">
                                                    <input class="form-control" id="p_desc" type="text" name="p_desc" placeholder="Descrição" maxlength="50" required/>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control" id="p_preco" type="number" name="p_preco" step="0.01" min="0.01" placeholder="0.00" required/>
                                                    <label for="p_preco">Preço</label>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-floating">
                                                    <input class="form-control" id="p_qtd" type="number" name="p_qtd" placeholder="Quantidade" step="1" min="1" max="9999" required/>
                                                    <label for="p_qtd">Quantidade</label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-0">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating">
                                                    <input class="form-control" id="p_fornecedor" type="text" name="p_fornecedor" placeholder="Fornecedor" maxlength="50" required/>
                                        ...
                                        <div class="row mb-3">                                            
                                            ...
                                            <div class="d-flex justify-content-end mt-3">
                                                <div class="d-grid"><button class="btn btn-primary btn-block" type="submit" name="button">Cadastrar Produto</button></div>
                                            </div>
                                        </div>  
                                    </div>
                                </form>
